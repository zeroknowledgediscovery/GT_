...
We can use actual travel distance if available.

\subsection{Probability SCaling and Summation}
We define operations on probability vectors somewhat differently:
...
\cgather{
\boxed{\wp'_i = c \odot \wp = \frac{\wp_i^c}{\sum_i \wp_i^c}}
}
\end{defn} 
\begin{example}
...
\cgather{
\boxed{(\wp \oplus \wp')_i =  \frac{\wp_i \wp_i'}{\sum_i \wp_i \wp_i'}}
}
\end{defn} 
\begin{example}
